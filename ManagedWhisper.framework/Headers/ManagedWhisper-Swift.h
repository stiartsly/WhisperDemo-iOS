...
+ (WMWhisper * _Nullable)getInstanceWithOptions:(WMWhisperOptions * _Nonnull)options delegate:(id <WMWhisperDelegate> _Nonnull)delegate error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
/// Get a whisper client singleton instance.
///
/// returns:
/// The whisper client instance or ni
+ (WMWhisper * _Nullable)getInstance SWIFT_WARN_UNUSED_RESULT;
...
- (WMWhisperUserInfo * _Nullable)getSelfUserInfo:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
- (WMWhisperNodeInfo * _Nullable)getNodeInfo:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
///
/// throws:
/// WhisperError
- (NSArray<WMWhisperFriendInfo *> * _Nullable)getFriends:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
- (WMWhisperFriendInfo * _Nullable)getFriendInfoForFriend:(NSString * _Nonnull)friendId error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// Void
- (void)whisper:(WMWhisper * _Nonnull)whisper connectionStatusDidChange:(enum WMWhisperConnectionStatus)newStatus;
@required
...
/// returns:
/// Void
- (void)whisperDidBecomeReady:(WMWhisper * _Nonnull)whisper;
@optional
...
/// returns:
/// Void
- (void)whisper:(WMWhisper * _Nonnull)whisper selfUserInfoDidChange:(WMWhisperUserInfo * _Nonnull)newInfo;
/// Tell the delegate to iterate each friend item in friend list.
/// \param whisper Whisper client instance
///
/// \param friends The friends list.
///
- (void)whisper:(WMWhisper * _Nonnull)whisper didReceiveFriendsList:(NSArray<WMWhisperFriendInfo *> * _Nonnull)friends;
...
/// returns:
/// Void
- (void)whisper:(WMWhisper * _Nonnull)whisper friendInfoDidChange:(NSString * _Nonnull)friendId newInfo:(WMWhisperFriendInfo * _Nonnull)newInfo;
...
/// returns:
/// Void
- (void)whisper:(WMWhisper * _Nonnull)whisper friendPresenceDidChange:(NSString * _Nonnull)friendId newPresence:(NSString * _Nonnull)newPresence;
...
/// returns:
/// Void
- (void)whisper:(WMWhisper * _Nonnull)whisper didReceiveFriendRequestFromUser:(NSString * _Nonnull)userId withUserInfo:(WMWhisperUserInfo * _Nonnull)userInfo hello:(NSString * _Nonnull)hello;
...
/// returns:
/// Void
- (void)whisper:(WMWhisper * _Nonnull)whisper didReceiveFriendResponseFromUser:(NSString * _Nonnull)userId withStatus:(NSInteger)status reason:(NSString * _Nullable)reason entrusted:(BOOL)entrusted expire:(NSString * _Nullable)expire;
...
/// returns:
/// Void
- (void)whisper:(WMWhisper * _Nonnull)whisper newFriendAdded:(WMWhisperFriendInfo * _Nonnull)newFriend;
...
/// returns:
/// Void
- (void)whisper:(WMWhisper * _Nonnull)whisper friendRemoved:(NSString * _Nonnull)friendId;
...
/// returns:
/// Void
- (void)whisper:(WMWhisper * _Nonnull)whisper didReceiveFriendMessage:(NSString * _Nonnull)from withMessage:(NSString * _Nonnull)message;
...
/// returns:
/// Void
- (void)whisper:(WMWhisper * _Nonnull)whisper didReceiveFriendInviteRequest:(NSString * _Nonnull)from withData:(NSString * _Nonnull)data;
@end
...
enum WMWhisperTransportType : NSInteger;
...
+ (WMWhisperSessionManager * _Nullable)getInstance:(WMWhisper * _Nonnull)whisper withOptions:(WMWhisperSessionManagerOptions * _Nonnull)options error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
/// Get a whisper session manager instance.
/// \param whisper Whisper client instance
///
/// \param options The options to set for whisper session manager.
...
/// returns:
/// A whisper session manager
+ (WMWhisperSessionManager * _Nullable)getInstance:(WMWhisper * _Nonnull)whisper withOptions:(WMWhisperSessionManagerOptions * _Nonnull)options usingHandler:(void (^ _Nonnull)(WMWhisper * _Nonnull, NSString * _Nonnull, NSString * _Nonnull))handler error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
/// Get a whisper session manager instance.
///
/// returns:
/// The whisper session manager or nil
+ (WMWhisperSessionManager * _Nullable)getInstance SWIFT_WARN_UNUSED_RESULT;
...
- (WMWhisperSession * _Nullable)newSessionTo:(NSString * _Nonnull)target transport:(enum WMWhisperTransportType)transport error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
/// returns:
/// Port forwarding ID
- (NSNumber * _Nullable)openPortForwardingForService:(NSString * _Nonnull)service withProtocol:(enum WMPortForwardingProtocol)proto host:(NSString * _Nonnull)host port:(NSString * _Nonnull)port error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
///
- (void)whisperStream:(WMWhisperStream * _Nonnull)stream stateDidChange:(enum WMWhisperStreamState)newState;
...
///
- (void)whisperStream:(WMWhisperStream * _Nonnull)stream didReceiveData:(NSData * _Nonnull)data;
...
- (BOOL)whisperStream:(WMWhisperStream * _Nonnull)stream shouldOpenNewChannel:(NSInteger)wantChannel withCookie:(NSString * _Nonnull)cookie SWIFT_WARN_UNUSED_RESULT;
/// Tell the delegate that new multiplexing channel has been opened.
/// \param stream The whisper stream instance
///
/// \param newChannel The channel ID
///
- (void)whisperStream:(WMWhisperStream * _Nonnull)stream didOpenNewChannel:(NSInteger)newChannel;
...
///
- (void)whisperStream:(WMWhisperStream * _Nonnull)stream didCloseChannel:(NSInteger)channel withReason:(enum WMCloseReason)reason;
...
- (BOOL)whisperStream:(WMWhisperStream * _Nonnull)stream didReceiveDataFromChannel:(NSInteger)channel withData:(NSData * _Nonnull)data SWIFT_WARN_UNUSED_RESULT;
...
/// \param channel The channel ID
///
- (void)whisperStream:(WMWhisperStream * _Nonnull)stream channelPending:(NSInteger)channel;
...
/// \param channel The channel ID
///
- (void)whisperStream:(WMWhisperStream * _Nonnull)stream channelResumed:(NSInteger)channel;
@end
