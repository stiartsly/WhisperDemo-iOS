...
/// return false
- (BOOL)didReceiveFriendRequest:(WMWhisper * _Nonnull)whisper fromUser:(NSString * _Nonnull)userId withUserInfo:(WMWhisperUserInfo * _Nonnull)userInfo hello:(NSString * _Nonnull)hello SWIFT_WARN_UNUSED_RESULT;
...
/// true if current callback consume this event, otherwise
/// return false
- (BOOL)didReceiveFriendResponse:(WMWhisper * _Nonnull)whisper fromUser:(NSString * _Nonnull)userId withStatus:(NSInteger)status reason:(NSString * _Nullable)reason entrusted:(BOOL)entrusted expire:(NSString * _Nullable)expire SWIFT_WARN_UNUSED_RESULT;
...
/// True if current callback consume this event, otherwise
/// return false
- (BOOL)didReceiveFriendMessage:(WMWhisper * _Nonnull)whisper from:(NSString * _Nonnull)from withMessage:(NSString * _Nonnull)message SWIFT_WARN_UNUSED_RESULT;
...
/// True if current callback consume this event, otherwise
/// return false
- (BOOL)didReceiveFriendInviteRequest:(WMWhisper * _Nonnull)whisper from:(NSString * _Nonnull)from withData:(NSString * _Nonnull)data SWIFT_WARN_UNUSED_RESULT;
@end
...
- (WMWhisperStream * _Nullable)addStreamWithType:(enum WMWhisperStreamType)type options:(WhisperStreamOptions)options components:(NSInteger)components delegate:(id <WMWhisperStreamDelegate> _Nonnull)delegate error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// A whisper session manager
+ (WMWhisperSessionManager * _Nullable)getInstance:(WMWhisper * _Nonnull)whisper withOptions:(WMWhisperSessionManagerOptions * _Nonnull)options usingHandler:(BOOL (^ _Nonnull)(WMWhisper * _Nonnull, NSString * _Nonnull, NSString * _Nonnull))handler error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
/// Get a whisper session manager instance.
///
/// returns:
...
- (WMWhisperSession * _Nullable)newSessionTo:(NSString * _Nonnull)target error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
- (NSNumber * _Nullable)writeDataToComponent:(NSInteger)component withData:(NSData * _Nonnull)data error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// New channel ID
- (NSNumber * _Nullable)openChannelWithinComponent:(NSInteger)component withCookie:(NSString * _Nonnull)cookie error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
- (NSNumber * _Nullable)writeChannelDataWithinComponent:(NSInteger)component toChannel:(NSInteger)channel withData:(NSData * _Nonnull)data error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// Port forwarding ID
- (NSNumber * _Nullable)openPortForwardingWithinComponent:(NSInteger)component forService:(NSString * _Nonnull)service withProtocol:(enum WMPortForwardingProtocol)proto host:(NSString * _Nonnull)host port:(NSString * _Nonnull)port error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)shouldOpenNewChannel:(WMWhisperStream * _Nonnull)stream withinComponent:(NSInteger)component wantChannel:(NSInteger)wantChannel withCookie:(NSString * _Nonnull)cookie SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)didReceiveChannelData:(WMWhisperStream * _Nonnull)stream withinComponent:(NSInteger)component fromChannel:(NSInteger)channel withData:(NSData * _Nonnull)data SWIFT_WARN_UNUSED_RESULT;
...
/// The stream closed normally.
  WMWhisperStreamStateClosed = 5,
/// The stream is deactivated.
  WMWhisperStreamStateDeactivated = 6,
